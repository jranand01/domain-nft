                                ...
                                <Accordion.Item eventKey="1">
                                    ...
                                    <Accordion.Body>
                                        ...
                                        <p><b>Contract Address:</b> <a
                                            href={selected_nfts.symbol === "UD" ? (`https://polygonscan.com/address/${selected_nfts.token_address}`) : selected_nfts.symbol === "ENS" ? (`https://metadata.ens.domains/mainnet/${selected_nfts.token_address}`) : ''}
